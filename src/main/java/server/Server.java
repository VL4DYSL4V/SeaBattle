...
//TODO: use 'Observer' pattern and dispatch requests to observers
@Deprecated
...
//                EXECUTOR.execute(task);
    ...
    private synchronized void handleRequest(Request request) throws NoSuchUserException {
    ...
    private void handleMove(Request moveRequest) throws NoSuchUserException, GameOverException {
    ...
    private void handleOtherRequests(Request request) throws NoSuchUserException {
    ...
    private void handleEndOfSession(String clientName) throws NoSuchUserException {
